        ...
        <>
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger>
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="inline-flex justify-center items-center p-0 ml-1 w-9 h-9 text-sm font-medium bg-transparent rounded-md transition-colors group text-accent-foreground ring-offset-background hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
                                                >
                                                    <span className="sr-only">{item.title}</span>
                                                    {item.icon && <Icon iconNode={item.icon} className="opacity-80 size-5 group-hover:opacity-100" />}
                                                </a>
                                            </TooltipTrigger>
                                            <TooltipContent>
                                                <p>{item.title}</p>
                            ...
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" className="p-1 rounded-full size-10">
                                    <Avatar className="overflow-hidden rounded-full size-8">
                                        ...
                                        <AvatarFallback className="text-black rounded-lg bg-neutral-200 dark:bg-neutral-700 dark:text-white">
            ...
            {breadcrumbs.length > 1 && (
                <div className="flex w-full border-b border-sidebar-border/70">
                    <div className="flex justify-start items-center px-4 mx-auto w-full h-12 text-neutral-500 md:max-w-7xl">
