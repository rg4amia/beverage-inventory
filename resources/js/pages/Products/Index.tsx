          ...
          <div className="overflow-hidden bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
            <div className="p-6">
              <div className="flex flex-col gap-4 justify-between items-start mb-8 sm:flex-row sm:items-center">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-200">Liste des produits</h2>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {productInstances.map((product) => (
                      <tr key={product.id} className="transition-colors duration-150 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            {product.image_path ? (
                              ...
                              <div className="flex justify-center items-center mr-3 w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-600 dark:text-gray-400">{product.barcode}</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
              ...
              {products.data.length === 0 && (
                <div className="py-12 text-center">
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Commencez par ajouter un nouveau produit.</p>
                </div>
              )}
